...
class Donor extends AbstractEntity
{
    ...
    #[OpenApi\Property(
        ...
        type: 'string',
        description: 'Donor identity number'
    )]
    ...
    #[OpenApi\Property(
        ...
        type: 'string',
        format: 'date',
        description: 'Donor date of birth'
    )]
    ...
    #[OpenApi\Property(
        ...
        type: 'string',
        description: 'Donor place of birth'
    )]
    ...
    #[OpenApi\Property(
        ...
        type: 'string',
        description: 'Donor neighborhood association'
    )]
    ...
    #[OpenApi\Property(
        ...
        type: 'string',
        description: 'Donor community association'
    )]
    ...
    #[ManyToOne(targetEntity: Volunteer::class, inversedBy: 'donors')]
    #[JoinColumn(name: 'volunteerRefId', referencedColumnName: 'id')]
    private Volunteer $volunteer;

    #[OneToMany(
        targetEntity: NuCoin::class,
        mappedBy: 'donor',
        cascade: ['persist'],
        orphanRemoval: true
    )]
    private PersistentCollection $nuCoins;

    #[OneToMany(
        targetEntity: NuCoinAggregator::class,
        mappedBy: 'donor',
        cascade: ['persist'],
        orphanRemoval: true
    )]
    private PersistentCollection $nuCoinAggregators;
    ...
    /**
     * @return Lazis\Api\Entity\Volunteer
     */
    ...
    /**
     * @param Lazis\Api\Entity\Volunteer $volunteer
     * @return void
     */
     ...
     */
    public function getNuCoins(): PersistentCollection
    {
        return $this->nuCoins;
    }

    /**
     * @param \Doctrine\ORM\PersistentCollection $nuCoins
     * @return void
     */
    public function setNuCoins(PersistentCollection $nuCoins): void
    {
        $this->nuCoins = $nuCoins;
    }

    /**
     * @return \Doctrine\ORM\PersistentCollection
     */
    public function getNuCoinAggregators(): PersistentCollection
    {
        return $this->nuCoinAggregators;
    }

    /**
     * @param \Doctrine\ORM\PersistentCollection $nuCoinAggregators
     * @return void
     */
    public function setNuCoinAggregators(PersistentCollection $nuCoinAggregators): void
    {
        $this->nuCoinAggregators = $nuCoinAggregators;
    }
