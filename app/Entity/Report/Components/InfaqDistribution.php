...
class InfaqDistribution extends AbstractEntity
{
     ...
     * @var int
     */
    #[Json(name: 'nuPeaceQurbanFund')]
    private int $nuPeaceQurbanFund;
     ...
     * @return int
     */
    public function getNuPeaceQurbanFund(): int
    {
        return $this->nuPeaceQurbanFund;
    }

    /**
     * @param int $nuPeaceQurbanFund
     * @return void
     */
    public function setNuPeaceQurbanFund(int $nuPeaceQurbanFund): void
    {
        $this->nuPeaceQurbanFund = $nuPeaceQurbanFund;
    }
     ...
     * @return void
     */
    public function addNuPeaceQurbanFund(int $nuPeaceQurbanFund): void
    {
        $this->nuPeaceQurbanFund += $nuPeaceQurbanFund;
    }
