 ...
 */
class OffBalanceSheetObserverRepository extends AbstractRepository
{
    use RepositoryTrait;
    ...
    public function count(int $scope, string $district, string $village): int
    {
        ...
        $queryBuilder = $queryBuilder
            ->select(sprintf('count(%s)', $entities[2]->getQueryBuilderAlias()))
     ...
     * @return array
     */
    public function resolvePaginationByMultipleConstraint(
        PageInterface $page,
        int $scope,
        string $district,
        string $village
        ...
        return $this->getMapper()
            ...
            ->withPage($page)
            ->paginateFromQueryBuilder($queryBuilder, $entities[2]);
    }
}
