...
use Lazis\Api\Repository\DonorContextualRepository;
 ...
 */
class DonorContextualController extends BaseController
{
    use ControllerTrait;
     ...
     */
    #[Route('/organizationContext/{oid}/donor', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/donor',
        tags: ['Donor Context'],
        responses: [
    ...
    public function getAllDonors(
        ...
        $repository = new DonorContextualRepository(
