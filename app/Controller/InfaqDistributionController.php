 ...
 */
class InfaqDistributionController extends BaseController
{
    /**
    ...
    #[Route('/infaqDistribution', method: 'GET')]
    #[OpenApi\Get(
        path: '/infaqDistribution',
    ...
    #[Route('/infaqDistribution/{id}', method: 'GET')]
    #[OpenApi\Get(
        path: '/infaqDistribution/{id}',
        tags: ['Infaq Distribution'],
        responses: [
            new OpenApi\Response(response: 200, description: 'OK'),
    ...
    public function getInfaqDistributionById(
        Request $request,
        Response $response,
        array $args
    ): Response {
        ...
        if (null === $result) {
            ...
            $builder = $builder
                ...
                ->withPair('message', sprintf(
                    'Infaq distribution data with id \'%s\' not found.',
                    $args['id']
                ));
    ...
    #[Route('/infaqDistribution/{id}', method: 'PUT')]
    #[OpenApi\Put(
        path: '/infaqDistribution/{id}',
        tags: ['Infaq Distribution'],
        responses: [
    ...
    public function updateInfaqDistribution(
        Request $request,
        Response $response,
        array $args
    ): Response {
    ...
    #[Route('/infaqDistribution/{id}', method: 'DELETE')]
    #[OpenApi\Delete(
        path: '/infaqDistribution/{id}',
        tags: ['Infaq Distribution'],
        responses: [
    ...
    public function deleteInfaqDistribution(
        Request $request,
        Response $response,
        array $args
    ): Response {
