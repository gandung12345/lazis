...
use Lazis\Api\Repository\AmilContextualRepository;
 ...
 */
class AmilContextualController extends BaseController
{
    use ControllerTrait;
     ...
     */
    #[Route('/organizationContext/{oid}/amil', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/amil',
        tags: ['Amil Context'],
        responses: [
    ...
    public function getAllAmils(
        ...
        $repository = new AmilContextualRepository(
