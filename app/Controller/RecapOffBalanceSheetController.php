...
use Throwable;
use Lazis\Api\Repository\RecapOffBalanceSheetRepository;
 ...
 */
class RecapOffBalanceSheetController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route('/recap/{oid}/year/{year}/offBalanceSheet', method: 'GET')]
    #[OpenApi\Get(
        path: '/recap/{oid}/year/{year}/offBalanceSheet',
        tags: ['Recap'],
        responses: [
    ...
    public function getOffBalanceSheetRecap(
        Request $request,
        Response $response,
        array $args
    ): Response {
        $repository = new RecapOffBalanceSheetRepository(
