...
use Lazis\Api\Repository\UsersContextualRepository;
 ...
 */
class UsersContextualController extends BaseController
{
    use ControllerTrait;
     ...
     */
    #[Route('/organizationContext/{oid}/users', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/users',
        tags: ['Users Context'],
        responses: [
    ...
    public function getAllUsers(
        ...
        $repository = new UsersContextualRepository(
