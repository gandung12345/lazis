...
use Lazis\Api\Repository\ReportDsklFundingChangeRepository;
use Lazis\Api\Schema\Report\ReportDsklFundingChangeSchema;
 ...
 */
class ReportDsklFundingChangeController extends BaseController
{
    #[Auth(
        role: [
    ...
    #[Route('/dsklFundingChange/report', method: 'POST')]
    #[OpenApi\Post(
        path: '/dsklFundingChange/report',
        tags: ['Report'],
        responses: [
    ...
    public function getReport(
        ...
        $schema = new ReportDsklFundingChangeSchema();
        ...
        $repository = new ReportDsklFundingChangeRepository(
