...
use Lazis\Api\Repository\VolunteerContextualRepository;
 ...
 */
class VolunteerContextualController extends BaseController
{
    use ControllerTrait;
     ...
     */
    #[Route('/organizationContext/{oid}/volunteer', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/volunteer',
        tags: ['Volunteer Context'],
        responses: [
    ...
    public function getAllVolunteers(
        ...
        $repository = new VolunteerContextualRepository(
