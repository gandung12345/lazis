...
use Lazis\Api\Repository\Observer\LegalObserverRepository;
 ...
 */
class LegalObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/legal/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/legal/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllLegals(
        ...
        $repository = new LegalObserverRepository(
