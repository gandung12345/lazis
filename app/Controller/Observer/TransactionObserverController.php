...
use Lazis\Api\Repository\Observer\TransactionObserverRepository;
 ...
 */
class TransactionObserverController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route(
        '/observer/transaction/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/transaction/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllTransactions(
        ...
        $repository = new TransactionObserverRepository(
