...
use Lazis\Api\Repository\Observer\ZakatDistributionObserverRepository;
 ...
 */
class ZakatDistributionObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/zakatDistribution/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/zakatDistribution/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllZakatDistributions(
        ...
        $repository = new ZakatDistributionObserverRepository(
