...
use Lazis\Api\Repository\Observer\DoneeObserverRepository;
 ...
 */
class DoneeObserverController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route(
        '/observer/donee/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/amil/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllDonees(
        ...
        $repository = new DoneeObserverRepository(
