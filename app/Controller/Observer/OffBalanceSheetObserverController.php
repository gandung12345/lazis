...
use Lazis\Api\Repository\Observer\OffBalanceSheetObserverRepository;
 ...
 */
class OffBalanceSheetObserverController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route(
        '/observer/offBalanceSheet/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/offBalanceSheet/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllOffBalanceSheets(
        ...
        $repository = new OffBalanceSheetObserverRepository(
