...
use Lazis\Api\Repository\Observer\VolunteerObserverRepository;
 ...
 */
class VolunteerObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/volunteer/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/volunteer/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllVolunteers(
        ...
        $repository = new VolunteerObserverRepository(
