...
use Lazis\Api\Repository\Observer\NuCoinObserverRepository;
 ...
 */
class NuCoinObserverController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route(
        '/observer/nuCoin/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/nuCoin/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllNuCoins(
        ...
        $repository = new NuCoinObserverRepository(
