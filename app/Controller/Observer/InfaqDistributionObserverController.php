...
use Lazis\Api\Repository\Observer\InfaqDistributionObserverRepository;
 ...
 */
class InfaqDistributionObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/infaqDistribution/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/infaqDistribution/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllInfaqDistributions(
        ...
        $repository = new InfaqDistributionObserverRepository(
