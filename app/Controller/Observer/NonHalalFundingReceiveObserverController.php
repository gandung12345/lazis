...
use Lazis\Api\Repository\Observer\NonHalalFundingReceiveObserverRepository;
 ...
 */
class NonHalalFundingReceiveObserverController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route(
        '/observer/nonHalalFundingReceive/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/nonHalalFundingReceive/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllNonHalalFundingReceives(
        ...
        $repository = new NonHalalFundingReceiveObserverRepository(
