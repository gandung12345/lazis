...
use Lazis\Api\Repository\Observer\BankAccountObserverRepository;
 ...
 */
class BankAccountObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/bankAccount/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/bankAccount/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllBankAccounts(
        ...
        $repository = new BankAccountObserverRepository(
