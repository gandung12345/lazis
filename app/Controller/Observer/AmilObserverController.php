...
use Lazis\Api\Repository\Observer\AmilObserverRepository;
 ...
 */
class AmilObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/amil/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
    ...
    public function getAllAmils(
        ...
        $repository = new AmilObserverRepository(
