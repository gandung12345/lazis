...
use Lazis\Api\Repository\Observer\OrganizationObserverRepository;
 ...
 */
class OrganizationObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/organization/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/organization/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllOrganizations(
        ...
        $repository = new OrganizationObserverRepository(
