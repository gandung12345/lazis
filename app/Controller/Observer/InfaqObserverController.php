...
use Lazis\Api\Repository\Observer\InfaqObserverRepository;
 ...
 */
class InfaqObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/infaq/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/infaq/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllInfaqs(
        ...
        $repository = new InfaqObserverRepository(
