...
use Lazis\Api\Repository\Observer\WalletObserverRepository;
 ...
 */
class WalletObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/wallet/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/wallet/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllWallets(
        ...
        $repository = new WalletObserverRepository(
