...
use Lazis\Api\Repository\Observer\ZakatObserverRepository;
 ...
 */
class ZakatObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/zakat/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/zakat/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllZakats(
        ...
        $repository = new ZakatObserverRepository(
