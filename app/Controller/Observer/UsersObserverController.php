...
use Lazis\Api\Repository\Observer\UsersObserverRepository;
 ...
 */
class UsersObserverController extends BaseController
{
    use ControllerTrait;

    #[Route(
        '/observer/users/{scope}/{district}/{village}',
        method: 'GET'
    )]
    #[OpenApi\Get(
        path: '/observer/users/{scope}/{district}/{village}',
        tags: ['Observer'],
        responses: [
    ...
    public function getAllUsers(
        ...
        $repository = new UsersObserverRepository(
