...
use Lazis\Api\Repository\NuCoinAggregatorContextualRepository;
 ...
 */
class NuCoinAggregatorContextualController extends BaseController
{
    use ControllerTrait;
     ...
     */
    #[Route('/organizationContext/{oid}/nuCoinAggregator', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/nuCoinAggregator',
        tags: ['NU Coin Aggregator Context'],
        responses: [
    ...
    public function getAllNuCoinAggregators(
        ...
        $repository = new NuCoinAggregatorContextualRepository(
