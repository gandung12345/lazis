...
use Lazis\Api\Repository\ZakatContextualRepository;
 ...
 */
class ZakatContextualController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route('/organizationContext/{oid}/zakat', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/zakat',
        tags: ['Zakat Context'],
        responses: [
    ...
    public function getAllZakats(
        ...
        $repository = new ZakatContextualRepository(
