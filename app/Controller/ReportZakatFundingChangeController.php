...
use Lazis\Api\Repository\ReportZakatFundingChangeRepository;
use Lazis\Api\Schema\Report\ReportZakatFundingChangeSchema;
 ...
 */
class ReportZakatFundingChangeController extends BaseController
{
    #[Route('/zakatFundingChange/report', method: 'POST')]
    #[OpenApi\Post(
        path: '/zakatFundingChange/report',
        tags: ['Report'],
        responses: [
    ...
    public function getReport(
        ...
        $schema = new ReportZakatFundingChangeSchema();
        ...
        $repository = new ReportZakatFundingChangeRepository(
