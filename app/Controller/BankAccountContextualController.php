...
use Lazis\Api\Repository\BankAccountContextualRepository;
 ...
 */
class BankAccountContextualController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route('/organizationContext/{oid}/bankAccount', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/bankAccount',
        tags: ['Bank Account Context'],
        responses: [
    ...
    public function getallBankAccounts(
        ...
        $repository = new BankAccountContextualRepository(
