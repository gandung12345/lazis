...
use Lazis\Api\Repository\MosqueContextualRepository;
 ...
 */
class MosqueContextualController extends BaseController
{
    use ControllerTrait;
     ...
     */
    #[Route('/organizationContext/{oid}/mosque', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/mosque',
        tags: ['Mosque Context'],
        responses: [
    ...
    public function getAllMosques(
        ...
        $repository = new MosqueContextualRepository(
