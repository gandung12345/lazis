...
use Lazis\Api\Repository\OrganizerContextualRepository;
 ...
 */
class OrganizerContextualController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route('/organizationContext/{oid}/organizer', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/organizer',
        tags: ['Organizer Context'],
        responses: [
    ...
    public function getAllOrganizers(
        ...
        $repository = new OrganizerContextualRepository(
