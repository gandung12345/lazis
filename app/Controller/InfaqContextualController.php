...
use Lazis\Api\Repository\InfaqContextualRepository;
 ...
 */
class InfaqContextualController extends BaseController
{
    use ControllerTrait;
     ...
     */
    #[Route('/organizationContext/{oid}/infaq', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/infaq',
        tags: ['Infaq Context'],
        responses: [
    ...
    public function getAllInfaqs(
        ...
        $repository = new InfaqContextualRepository(
