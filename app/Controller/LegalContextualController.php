...
use Lazis\Api\Repository\LegalContextualRepository;
 ...
 */
class LegalContextualController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route('/organizationContext/{oid}/legal', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/legal',
        tags: ['Legal Context'],
        responses: [
            new OpenApi\Response(response: 200, description: 'OK'),
            new OpenApi\Response(response: 400, description: 'Not Found')
        ]
    )]
    public function getAllLegals(
        Request $request,
        Response $response,
        array $args
    ): Response {
        $repository = new LegalContextualRepository(
