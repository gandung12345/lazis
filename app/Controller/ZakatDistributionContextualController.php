...
use Lazis\Api\Repository\ZakatDistributionContextualRepository;
 ...
 */
class ZakatDistributionContextualController extends BaseController
{
    use ControllerTrait;
     ...
     */
    #[Route('/organizationContext/{oid}/zakatDistribution', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/zakatDistribution',
        tags: ['Zakat Distribution Context'],
        responses: [
