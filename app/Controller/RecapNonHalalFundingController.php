...
use Throwable;
use Lazis\Api\Repository\RecapNonHalalFundingRepository;
 ...
 */
class RecapNonHalalFundingController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route('/recap/{oid}/year/{year}/nonHalalFunding', method: 'GET')]
    #[OpenApi\Get(
        path: '/recap/{oid}/year/{year}/nonHalalFunding',
        tags: ['Recap'],
        responses: [
    ...
    public function getNonHalalFundingRecap(
        Request $request,
        Response $response,
        array $args
    ): Response {
        $repository = new RecapNonHalalFundingRepository(
