 ...
 */
class AmilFundingController extends BaseController
{
    /**
    ...
    #[Route('/amilFunding/{id}', method: 'GET')]
    #[OpenApi\Get(
        path: '/amilFunding/{id}',
        tags: ['Amil Funding'],
        responses: [
    ...
    public function getAmilFundingById(
        Request $request,
        Response $response,
        array $args
    ): Response {
        ...
        if (null === $result) {
            ...
            $builder = $builder
                ...
                ->withPair('message', sprintf(
                    'Amil funding data with id \'%s\' not found.',
                    $args['id']
                ));
    ...
    public function updateAmilFunding(
        Request $request,
        Response $response,
        array $args
    ): Response {
    ...
    public function deleteAmilFunding(
        Request $request,
        Response $response,
        array $args
    ): Response {
