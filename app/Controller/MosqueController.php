...
class MosqueController extends BaseController
{
    ...
    #[Route('/mosque/{mid}/offBalanceSheet', method: 'POST')]
    #[OpenApi\Post(
        path: '/mosque/{mid}/offBalanceSheet',
        tags: ['Mosque'],
        responses: [
    ...
    public function createOffBalanceSheet(
        Request $request,
        Response $response,
        array $args
    ): Response {
