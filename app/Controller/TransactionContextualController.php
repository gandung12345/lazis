...
use Lazis\Api\Repository\TransactionContextualRepository;
 ...
 */
class TransactionContextualController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route('/organizationContext/{oid}/transaction', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/transaction',
        tags: ['Transaction Context'],
        responses: [
    ...
    public function getAllTransactions(
        ...
        $repository = new TransactionContextualRepository(
