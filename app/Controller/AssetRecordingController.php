...
class AssetRecordingController extends BaseController
{
    ...
    public function getAssetRecordingById(
        Request $request,
        Response $response,
        array $args
    ): Response {
        ...
        if (null === $result) {
            ...
            $builder = $builder
                ...
                ->withPair('message', sprintf(
                    'Asset recording data with id \'%s\' not found.',
                    $args['id']
                ));
    ...
    public function updateAssetRecording(
        Request $request,
        Response $response,
        array $args
    ): Response {
    ...
    public function deleteAssetRecording(
        Request $request,
        Response $response,
        array $args
    ): Response {
