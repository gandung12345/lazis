...
use Lazis\Api\Repository\NonHalalFundingDistributionContextualRepository;
 ...
 */
class NonHalalFundingDistributionContextualController extends BaseController
{
    use ControllerTrait;
    ...
    #[Route('/organizationContext/{oid}/nonHalalFundingDistribution', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/nonHalalFundingDistribution',
        tags: ['Non Halal Funding Distribution Context'],
        responses: [
    ...
    public function getAllNonHalalFundingDistributions(
        ...
        $repository = new NonHalalFundingDistributionContextualRepository(
