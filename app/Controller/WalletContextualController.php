...
use Lazis\Api\Repository\WalletContextualRepository;
 ...
 */
class WalletContextualController extends BaseController
{
    use ControllerTrait;
     ...
     */
    #[Route('/organizationContext/{oid}/wallet', method: 'GET')]
    #[OpenApi\Get(
        path: '/organizationContext/{oid}/wallet',
        tags: ['Wallet Context'],
        responses: [
    ...
    public function getAllWallets(
        ...
        $repository = new WalletContextualRepository(
