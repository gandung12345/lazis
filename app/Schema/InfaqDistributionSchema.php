 ...
 */
class InfaqDistributionSchema extends AbstractSchema
{
    use SchemaTrait;
    ...
    /**
     * @var \Lazis\Api\Schema\DoneeSerializationAwareSchema|null $donee
     */
    #[Rule(required: true)]
    #[Json(name: '@donee')]
    private ?DoneeSerializationAwareSchema $donee;
     ...
     * @param \Lazis\Api\Schema\DoneeSerializationAwareSchema|null $donee
     * @return static
     */
    public function __construct(
        ...
        ?string $proof = null,
        ?DoneeSerializationAwareSchema $donee = null
    ) {
        $this->setDate($date);
     ...
     */
    public function getDonee(): ?DoneeSerializationAwareSchema
    {
        return $this->donee;
    }
     ...
     * @return void
     */
    public function setDonee(?DoneeSerializationAwareSchema $donee): void
    {
        $this->donee = $donee;
    }
}
