 ...
 */
class NuCoinSchema extends AbstractSchema
{
    use SchemaTrait;

    /**
     * @var \Schnell\Decorator\Stringified\DateTimeDecorator|null $date
     */
    #[Rule(required: true)]
    #[Json(name: 'date')]
     ...
     * @return static
     */
    public function __construct(?DateTimeDecorator $date = null, ?int $amount = null)
    {
        $this->setDate($date);
